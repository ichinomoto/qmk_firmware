...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Lower |Raise | GUI  | Alt  |Space |Space |Lower |Raise |Raise |Lower | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   * Adjst‚ÍLower+Raise‚Ì‚Ý
   */
  [_QWERTY] = LAYOUT( \
      ...
      LOWER,   RAISE,   KC_LGUI, KC_LALT, KC_SPC,  KC_SPC,  LOWER,   RAISE,   RAISE,   LOWER,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_PIPE, \
      KC_LSFT, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_LPRN, KC_RPRN, KC_F12,  _______, _______, _______, _______,  _______, \
  ...
  [_RAISE] = LAYOUT( \
      ...
      KC_TAB,  KC_F11,  KC_F12,  _______, _______, _______,                   _______, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_GRV, \
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_LEFT, KC_DOWN, KC_LEFT, KC_RGHT, _______, _______, \
      KC_LSFT, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  _______, _______, _______, _______, _______, _______, _______, _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END\
      ),
